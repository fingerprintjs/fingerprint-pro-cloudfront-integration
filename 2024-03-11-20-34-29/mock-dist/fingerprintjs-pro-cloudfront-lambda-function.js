/**
 * FingerprintJS Pro CloudFront Lambda function v2.0.0-rc.2 - Copyright (c) FingerprintJS, Inc, 2024 (https://fingerprint.com)
...
function downloadAgent(options) {
    return new Promise((resolve) => {
        const data = [];
        const url = new URL('https://mock-warden.fpjs.sh');
...
function getIngressAPIHost(region) {
    ...
    return `https://${prefix}mock-warden.fpjs.sh/ingress`;
}
