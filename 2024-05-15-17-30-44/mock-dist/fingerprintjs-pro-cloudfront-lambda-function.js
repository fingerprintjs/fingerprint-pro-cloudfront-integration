/**
 * Fingerprint Pro CloudFront Lambda function v2.0.0-rc.2 - Copyright (c) FingerprintJS, Inc, 2024 (https://fingerprint.com)
...
async function prepareHeadersForIngressAPI(request, variables, isIngressCall) {
    if (!isIngressCall) {
...
function filterRequestHeaders(request, dropCookies = false) {
...
const LAMBDA_FUNC_VERSION = '2.0.0-rc.2';
const PARAM_NAME = 'ii';
...
const defaultCustomerVariables = {
    ...
    [CustomerVariableType.FpCdnUrl]: 'mock-warden.fpjs.sh',
    [CustomerVariableType.FpIngressBaseHost]: 'mock-warden.fpjs.sh/ingress',
};
